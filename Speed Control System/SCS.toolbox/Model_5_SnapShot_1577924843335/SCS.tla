...
(*********************************************************************************)
End == speed /= desiredLimit

(*********************************************************************************)
(* This predicate is an invariant and remains true across all of the states.     *)
(*********************************************************************************)
TypeOK == /\ cc \in {"on", "off"}
          /\ desiredLimit \in 2..4 \* 2-slow 3-medium 4-fast
          /\ desiredSpeed \in 2..4 \*2-slow 3-medium 4-fast
          /\ lever \in 0..5
          /\ sl \in {"on", "off"}
...
\* Last modified Thu Jan 02 00:27:21 WET 2020 by ricardo
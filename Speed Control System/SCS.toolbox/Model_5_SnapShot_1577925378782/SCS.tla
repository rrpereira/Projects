...
\* Macros variables are established below.
minSpeed == 2
maxSpeed == 4
...
(*********************************************************************************)
TypeOK == /\ cc \in {"on", "off"}
          /\ desiredLimit \in minSpeed..4 \* 2-slow 3-medium 4-fast
          /\ desiredSpeed \in minSpeed..4 \*2-slow 3-medium 4-fast
          /\ lever \in 0..5
          /\ sl \in {"on", "off"}
          /\ speed \in 1..4 \* 1-stopped 2-slow 3-medium 4-fast
...
(*********************************************************************************)
PropertiesOK == /\ \/ (speed <= desiredLimit /\ sl = "on") (**********************)
                   \/ (sl = "off")                         (* The speed limit is *)
                                                           (* either on and      *)
                                                           (* respected or off.  *)
                                                           (**********************)
...
\* Lever goes to its neutral state after being manipulated.
TurnLever0 == /\ lever         /= 0 
              /\ cc'           = cc
              /\ desiredLimit' = desiredLimit
              /\ desiredSpeed' = desiredSpeed 
...
\* Last modified Thu Jan 02 00:36:13 WET 2020 by ricardo